            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <!-- Start From  -->
                    <form id="demo-form2" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" action="<?PHP echo url('/'); ?>/insertProject" method="post">
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12"> Section:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="sec" placeholder="e.g., 013 กรอกเลข 3 หลัก ดูข้อมูลที่เว็ปสำนักทะเบียน">
                        </div><div class="content_redStrong">*</div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="titleEN">
                        </div><div class="content_redStrong">*</div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" required="" name="titleTH">
                        </div><div class="content_redStrong">*</div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="advisor" required="required" class="form-control col-md-7 col-xs-12" >
                            <option value="FG02">Trasapong Thaiupathump</option>
                              ...
                              <option value="FG08">Navadon Khunlertgit</option>
                              ...
                              <option value="FG21">Karn Patanukhom</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="std[]" required="required" class="form-control col-md-7 col-xs-12" value="{{ session('userID')}}">
                        </div><div class="content_redStrong">*</div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="year" value="<?php echo date("Y")+543; ?>">
                        </div><div class="content_redStrong">*</div>
                      </div>
                    <!--
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Source Files:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" name="source" class="form-control col-md-7 col-xs-12"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">PDF File:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" name="pdf" class="form-control col-md-7 col-xs-12"/>
                        </div>
                      </div>
                      <div class="form-group">
