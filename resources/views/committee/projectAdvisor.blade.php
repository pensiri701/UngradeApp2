                        ...
                        <tr>
                          ...
                          <td>
                              ...
                              <a href="{{ url('committee', [$project['project']['pid']]) }}">
                                   <div ><strong>{{ $project['project']['projectTitleEN'] }} </strong></div> <br />
                          ...
                          <td>
                            @foreach($project['committee'] as $committee)
                              ...
                              @if($committee['committee']['statusApprov']=="1")
                                  <a href="{{ url('committee/'.$project['project']['pid'].'/'.$committee['committee']['statusApprov']) }}" class="btn btn-success btn-xs" title="Click to change status">Approved</a>
                                @else
                                  <a href="{{ url('committee/'.$project['project']['pid'].'/'.$committee['committee']['statusApprov']) }}" class="btn btn-danger btn-xs" title="Click to change status">Pending</a>
                                @endif
                               @endif
                             @endforeach
                           ...
                           <td>
                            <div class="media-right">
                              <a href="{{ url('committee/edit', [$project['project']['pid']]) }}" class="btn btn-info btn-xs" title="Click to Edit Project Detail"><i class="fa fa-pencil"></i> Edit </a>
                            </div>
                          </td>
                          <!--
                           <td>
