          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Project  <small> &nbsp:</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left" action="<?PHP echo url('/'); ?>/committee/updateProject" method="post"  enctype="multipart/form-data">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Project Title (English):</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12" type="text" name="titleEN" value="{{ $project['project']['projectTitleEN'] }}">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Project Title (Thai):</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12" type="text" name="titleTH" value="{{ $project['project']['projectTitleTH'] }}">
                        </div>
                      ...
                      <div class="form-group">
                        <label class="col-md-3 col-sm-3 col-xs-12 control-label">Auther:</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <input type="hidden" name="pid" value="{{ $project['project']['pid']  }}" />
