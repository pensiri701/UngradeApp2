                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <div>
                             <a href="/committee/{{ $project['project']['pid']  }}">
                              <strong></strong> {{ $project['project']['projectTitleEN'] }}<br />
                          ...
                          <td>
                           ...
                           <td>
                             <div class="media-right">
                                <a href="{{ url('committee', [$project['project']['pid']]) }}">   class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                             </div>
