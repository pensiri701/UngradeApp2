      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
           <form id="demo-form2" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" action="<?PHP echo url('/'); ?>/loginSubmit" method="post">

              <h1>Login Project App</h1>
              <div>
                <div>
                  <input type="text" class="form-control" placeholder="Student ID" required  name="studentID"/>
                </div>
                <div>
