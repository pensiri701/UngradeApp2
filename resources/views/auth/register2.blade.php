          ...
          <!-- <form class="form-horizontal" method="POST" action="{{ route('login') }}">-->
           <form name="form" id="form" class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ url('/loginme') }}">
              ...
              <div>
                                        ...
                                        {{ csrf_field() }}
                                        <div>
                                          <input type="text" class="form-control" placeholder="Student ID" required="" name="stdId"/>
                                        </div>
                                        <div>
                                          <input type="text" class="form-control" placeholder="Name EX: pensiri kusalaporn" required="" name="stdName" />
                                        </div>
                                        <div>
